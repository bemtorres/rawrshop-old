<div class="card cardd-hover shadow align-self-stretch">
  ...
  <div class="card-img-overlay py-0 px-1">
    <div class="card-title justify-content-between">
      @if ($p->favorito_check)
        <span class="badge bg-warning" id="text_title_dos">
          <i id="text_icon_dos" class="fa fa-star"></i>
        </span>
      @endif
      @if (!$p->fuera_stock)
        @php
  ...
  <div class="card-body">
    <div class="align-items-center text-center mb-2">
      <div class="btn-group" role="group" aria-label="Button group">
        <a class="btn btn-primary btn-sm" href="{{ route('productos.show',$p->id) }}" target="_blank" rel="noopener noreferrer">
        ...
        <button
          ...
          data-bs-precio="{{ $p->variedades->first()->precio }}"
          data-bs-descuento="{{ $p->variedades->first()->precio_descuento }}"
          data-bs-id="{{ $p->id }}"
          >
          <i class="fa fa-money-bill-alt"></i>
      </button>
        <a class="btn btn-info btn-sm" href="{{ route('home.producto',$p->codigo) }}" target="_blank" rel="noopener noreferrer">
